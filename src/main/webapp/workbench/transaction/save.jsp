...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	<script>
		...
		$(function () {
			...
			$("#create-customerName").typeahead({
				source: function (query, process) {
					$.get(
							"${pageContext.request.contextPath}/tranController/getCustomerName",
							{ "name" : query },
							function (data) {
								/**
								 * data
		...
		function fun1(){
            ...
            * 目标：填写可能性
            * 阶段有了stage
            * 阶段和可能性之间的对应关系PMap，但是pMap是java语言中的键值关系（java中的map对象）
            * 首先要把js中的键值转换为JSON
            *
            * */
			/**
...
<body>
	...
	<form class="form-horizontal" id="tranForm" action="${pageContext.request.contextPath}/tranController/save.do" method="post" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="103e2edfd2fe4cf4aa2f4f131cf91f7a" name="activityId" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="b297a7d4d729420c9813918054ac5544" name="contactsId" />
			</div>
		</div>
