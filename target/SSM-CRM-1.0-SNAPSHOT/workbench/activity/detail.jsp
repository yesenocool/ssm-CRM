...
<script type="text/javascript">
	...
	function showRemarkList(){
		$.ajax({
			url:"${pageContext.request.contextPath}/active/getRemarkListByAid",
			data:{
	...
	function deleteRemark(id) {
	    $.ajax({
            url:"${pageContext.request.contextPath}/active/deleteRemark",
            data:{"id":id},
            dataType: "json",
            type:"post",
            success:function (data) {
    ...
    function saveRemark() {
        $.ajax({
            url:"${pageContext.request.contextPath}/active/saveRemark",
            data:{
    ...
    function updateRemark() {
	    ...
	    $.ajax({
            url:"${pageContext.request.contextPath}/active/updateRemark",
            type:"post",
            data:{
                "id":id,
