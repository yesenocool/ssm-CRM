			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody id="clueActivety">
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}/clue/showDetail?id=f6a537ee14d446a08dfdffa6148a1a20';">李四先生</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
